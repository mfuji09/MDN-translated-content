...
[置換要素](/ja/docs/Web/CSS/Replaced_element)は常に独立した[整形コンテキスト](/ja/docs/Web/CSS/CSS_flow_layout/Introduction_to_formatting_contexts)を確立するので、置換コンテンツのオーバーフローは常にインクオーバーフローとなります（[スクロール可能なオーバーフロー](/ja/docs/Learn_web_development/Core/Styling_basics/Overflow)とは異なります）。
