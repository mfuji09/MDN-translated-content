...
**禁止リクエストヘッダー**は、リクエストにおいてプログラム的に設定したり変更したりすることができない [HTTP ヘッダー](/ja/docs/Web/HTTP/Headers)の名前と値の組み合わせです。レスポンスで変更することが禁止されているヘッダーについては、{{Glossary("Forbidden response header name", "禁止レスポンスヘッダー名")}}を参照してください。
