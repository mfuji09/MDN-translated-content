...
この記事では、ウェブ開発者が適材適所のツールを選択できるように、 CSS セレクターと XPath の違いを説明することを目的としています。

| [XPath 機能](/ja/docs/Web/XML/XPath)                                                                                                                                                                        | [相当する CSS](/ja/docs/Web/CSS/CSS_selectors)                                                                                 |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| [`ancestor`](/ja/docs/Web/XML/XPath/Reference/Axes#ancestor)、[`parent`](/ja/docs/Web/XML/XPath/Reference/Axes#parent)、[`preceding-sibling`](/ja/docs/Web/XML/XPath/Reference/Axes#preceding-sibling) の軸 | {{CSSxRef(":has",":has()")}} セレクター {{experimental_inline}}                                                                |
