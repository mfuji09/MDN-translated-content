...
use. The returned {{domxref("FileSystem")}} is then available for use with the other [file system APIs](/ja/docs/Web/API/File_and_Directory_Entries_API).
...
- [File and Directory Entries API support in Firefox](/ja/docs/Web/API/File_and_Directory_Entries_API/Firefox_support)
