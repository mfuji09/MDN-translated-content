...
The **`getDefaultComputedStyle()`** method gives the default [computed values](/ja/docs/Web/CSS/computed_value) of all the CSS
...
The returned `style` is a [`CSSStyleDeclaration`](/ja/docs/Web/API/CSSStyleDeclaration)
