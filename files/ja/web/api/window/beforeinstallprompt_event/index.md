...
The **`beforeinstallprompt`** event fires when the browser has detected that a website can be [installed as a Progressive Web App](/ja/docs/Web/Progressive_web_apps/Guides/Making_PWAs_installable).
