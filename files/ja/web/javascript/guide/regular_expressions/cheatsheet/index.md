...
<table class="standard-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <p>
          "n" には非負の整数が入ります。直前のアイテム "x" の少なくとも "n"
    ...
    <tr>
      ...
      <td>
        <!-- cSpell:ignore cndy -->
        <p>
          ここで、"n" と "m" は非負の整数で、<code>m >= n</code> である場合、直前の項目 "x" に最小で "n" 回、最大で "m" 回一致します。
          例えば <code>/a{1,3}/</code> は "cndy" では一致せず、"candy" の 'a'、"caandy"
